...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(TVMAZE_API_URL, "/search/shows?q=").concat(term))];
                case 1:
                    resp = _a.sent();
                    shows = resp.data;
                    return [2 /*return*/, shows.map(function (result) {
                            var _a;
                            return {
                                id: result.show.id,
                                name: result.show.name,
                                summary: result.show.summary,
                                image: ((_a = result.show.image) === null || _a === void 0 ? void 0 : _a.medium) || DEFAULT_IMAGE_URL
                            };
                        })];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    resp = _a.sent();
                    episodes = resp.data;
                    return [2 /*return*/, episodes.map(function (result) {
                            return {
                                id: result.id,
                                name: result.name,
 ...
 *  Shows episodes area.
 */
function getEpisodesAndDisplay(id) {
    return __awaiter(this, void 0, void 0, function () {
        var episodes;
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getEpisodesAndDisplay(id)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
