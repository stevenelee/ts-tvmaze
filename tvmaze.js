...
var TVMAZE_API_URL = "https://api.tvmaze.com/search";
...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(TVMAZE_API_URL, "/shows?q=").concat(term))];
                case 1:
                    resp = _a.sent();
                    shows.map(function (show) { return show.image === null ? show.image = DEFAULT_IMAGE_URL
